...
public class Dimensional Pocket extends EntityModel<Entity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Bottom = Hips.addChild("Bottom", ModelPartBuilder.create().uv(0, 28).cuboid(-7.0F, -3.0F, -7.0F, 14.0F, 3.0F, 14.0F, new Dilation(0.0F))
		...
		.uv(0, 28).cuboid(-1.0F, -2.0F, -15.0F, 2.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 7.0F, -1.6581F, 0.0F, 0.0F));
