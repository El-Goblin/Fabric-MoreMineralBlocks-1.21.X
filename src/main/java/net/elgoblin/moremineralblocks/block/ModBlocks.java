...
public class ModBlocks {
    ...
    private static BlockSoundGroup METAL = BlockSoundGroup.METAL;
    private static BlockSoundGroup AMETHYST = BlockSoundGroup.AMETHYST_BLOCK;
    private static BlockSoundGroup GLASS = BlockSoundGroup.GLASS;

    private record SettingsPack(float strength, float resistance, boolean requiresTool, BlockSoundGroup soundGroup) {}
    ...
    static SettingsPack calcitePack = new SettingsPack(0.75F, -1F, true, BlockSoundGroup.CALCITE);
    static SettingsPack netheritePack = new SettingsPack(50F, 1200F, true, BlockSoundGroup.NETHERITE);
    ...
    static SettingsPack sculkPack = new SettingsPack(0.2F, -1F, false, BlockSoundGroup.SCULK);
    ...
    static SettingsPack deepslateEmeraldOrePack = new SettingsPack(4.5F, 3.0F, true, BlockSoundGroup.DEEPSLATE);
    static SettingsPack prismarinePack = new SettingsPack(1.5F, 6.0F, true, null);

    private static AbstractBlock.Settings abstractBlockSettings(String name, SettingsPack settings) {
        AbstractBlock.Settings blockSettings = AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoreMineralBlocks.MOD_ID, name)));
        if (settings.strength != -1F) { blockSettings.strength(settings.strength);}
        if (settings.resistance != -1F) { blockSettings.resistance(settings.resistance);}
        if (settings.requiresTool) { blockSettings.requiresTool();}
        if (settings.soundGroup != null) { blockSettings.sounds(settings.soundGroup);}
        return blockSettings;
    }

    private static AbstractBlock.Settings abstractBlockSettings(String name) {
        return AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoreMineralBlocks.MOD_ID, name)));
    }
    ...
    public static final Block GOLD_SLAB = registerBlock("gold_slab",
            new SlabBlock(abstractBlockSettings("gold_slab", goldPack)));

    public static final Block GOLD_FENCE = registerBlock("gold_fence",
            new FenceBlock(abstractBlockSettings("gold_fence", goldPack)));

    public static final Block GOLD_FENCE_GATE = registerBlock("gold_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("gold_fence_gate", goldPack)));

    public static final Block GOLD_WALL = registerBlock("gold_wall",
            new WallBlock(abstractBlockSettings("gold_wall", goldPack)));

    public static final Block GOLD_DOOR = registerBlock("gold_door",
            new DoorBlock(BlockSetType.GOLD, abstractBlockSettings("gold_door", goldPack)));

    public static final Block GOLD_TRAPDOOR = registerBlock("gold_trapdoor",
            new TrapdoorBlock(BlockSetType.GOLD, abstractBlockSettings("gold_trapdoor", goldPack).nonOpaque()));

    public static final Block POLISHED_GOLD_BLOCK = registerBlock("polished_gold_block",
            new Block(abstractBlockSettings("polished_gold_block", goldPack).instrument(NoteBlockInstrument.BELL)));

    public static final Block CALCIFIED_GOLD_BLOCK = registerBlock("calcified_gold_block",
            new Block(abstractBlockSettings("calcified_gold_block", goldPack)));

    public static final Block GOLD_BRICKS = registerBlock("gold_bricks",
            new Block(abstractBlockSettings("gold_bricks", goldPack).instrument(NoteBlockInstrument.BELL)));

    public static final Block GOLD_BRICK_STAIRS = registerBlock("gold_brick_stairs",
            new StairsBlock(ModBlocks.GOLD_BRICKS.getDefaultState(), abstractBlockSettings("gold_brick_stairs", goldPack)));

    public static final Block GOLD_BRICK_SLAB = registerBlock("gold_brick_slab",
            new SlabBlock(abstractBlockSettings("gold_brick_slab", goldPack)));

    public static final Block GOLD_BRICK_FENCE = registerBlock("gold_brick_fence",
            new FenceBlock(abstractBlockSettings("gold_brick_fence", goldPack)));

    public static final Block GOLD_BRICK_FENCE_GATE = registerBlock("gold_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("gold_brick_fence_gate", goldPack)));

    public static final Block GOLD_BRICK_WALL = registerBlock("gold_brick_wall",
            new WallBlock(abstractBlockSettings("gold_brick_wall", goldPack)));

    public static final Block CALCIFIED_GOLD_STAIRS = registerBlock("calcified_gold_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_GOLD_BLOCK.getDefaultState(), abstractBlockSettings("calcified_gold_stairs", goldPack)));

    public static final Block CALCIFIED_GOLD_SLAB = registerBlock("calcified_gold_slab",
            new SlabBlock(abstractBlockSettings("calcified_gold_slab", goldPack)));

    public static final Block CALCIFIED_GOLD_FENCE = registerBlock("calcified_gold_fence",
            new FenceBlock(abstractBlockSettings("calcified_gold_fence", goldPack)));

    public static final Block CALCIFIED_GOLD_FENCE_GATE = registerBlock("calcified_gold_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_gold_fence_gate", goldPack)));

    public static final Block CALCIFIED_GOLD_WALL = registerBlock("calcified_gold_wall",
            new WallBlock(abstractBlockSettings("calcified_gold_wall", goldPack)));

    public static final Block POLISHED_GOLD_STAIRS = registerBlock("polished_gold_stairs",
            new StairsBlock(ModBlocks.POLISHED_GOLD_BLOCK.getDefaultState(), abstractBlockSettings("polished_gold_stairs", goldPack)));

    public static final Block POLISHED_GOLD_SLAB = registerBlock("polished_gold_slab",
            new SlabBlock(abstractBlockSettings("polished_gold_slab", goldPack)));

    public static final Block POLISHED_GOLD_FENCE = registerBlock("polished_gold_fence",
            new FenceBlock(abstractBlockSettings("polished_gold_fence", goldPack)));

    public static final Block POLISHED_GOLD_FENCE_GATE = registerBlock("polished_gold_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_gold_fence_gate", goldPack)));

    public static final Block POLISHED_GOLD_WALL = registerBlock("polished_gold_wall",
            new WallBlock(abstractBlockSettings("polished_gold_wall", goldPack)));

    // DIAMOND BLOCKS

    public static final Block DIAMOND_STAIRS = registerBlock("diamond_stairs",
            new StairsBlock(Blocks.DIAMOND_BLOCK.getDefaultState(), abstractBlockSettings("diamond_stairs", diamondPack)));

    public static final Block DIAMOND_SLAB = registerBlock("diamond_slab",
            new SlabBlock(abstractBlockSettings("diamond_slab", diamondPack)));

    public static final Block DIAMOND_FENCE = registerBlock("diamond_fence",
            new FenceBlock(abstractBlockSettings("diamond_fence", diamondPack)));

    public static final Block DIAMOND_FENCE_GATE = registerBlock("diamond_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("diamond_fence_gate", diamondPack)));

    public static final Block DIAMOND_WALL = registerBlock("diamond_wall",
            new WallBlock(abstractBlockSettings("diamond_wall", diamondPack)));

    public static final Block DIAMOND_DOOR = registerBlock("diamond_door",
            new DoorBlock(BlockSetType.OAK, abstractBlockSettings("diamond_door", diamondPack).nonOpaque()));

    public static final Block DIAMOND_TRAPDOOR = registerBlock("diamond_trapdoor",
            new TrapdoorBlock(BlockSetType.OAK, abstractBlockSettings("diamond_trapdoor", diamondPack).nonOpaque()));

    public static final Block POLISHED_DIAMOND_BLOCK = registerBlock("polished_diamond_block",
            new Block(abstractBlockSettings("polished_diamond_block", diamondPack)));

    public static final Block CALCIFIED_DIAMOND_BLOCK = registerBlock("calcified_diamond_block",
            new Block(abstractBlockSettings("calcified_diamond_block", diamondPack)));

    public static final Block DIAMOND_BRICKS = registerBlock("diamond_bricks",
            new Block(abstractBlockSettings("diamond_bricks", diamondPack)));

    public static final Block DIAMOND_BRICK_STAIRS = registerBlock("diamond_brick_stairs",
            new StairsBlock(ModBlocks.DIAMOND_BRICKS.getDefaultState(), abstractBlockSettings("diamond_brick_stairs", diamondPack)));

    public static final Block DIAMOND_BRICK_SLAB = registerBlock("diamond_brick_slab",
            new SlabBlock(abstractBlockSettings("diamond_brick_slab", diamondPack)));

    public static final Block DIAMOND_BRICK_FENCE = registerBlock("diamond_brick_fence",
            new FenceBlock(abstractBlockSettings("diamond_brick_fence", diamondPack)));

    public static final Block DIAMOND_BRICK_FENCE_GATE = registerBlock("diamond_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("diamond_brick_fence_gate", diamondPack)));

    public static final Block DIAMOND_BRICK_WALL = registerBlock("diamond_brick_wall",
            new WallBlock(abstractBlockSettings("diamond_brick_wall", diamondPack)));

    public static final Block CALCIFIED_DIAMOND_STAIRS = registerBlock("calcified_diamond_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_DIAMOND_BLOCK.getDefaultState(), abstractBlockSettings("calcified_diamond_stairs", diamondPack)));

    public static final Block CALCIFIED_DIAMOND_SLAB = registerBlock("calcified_diamond_slab",
            new SlabBlock(abstractBlockSettings("calcified_diamond_slab", diamondPack)));

    public static final Block CALCIFIED_DIAMOND_FENCE = registerBlock("calcified_diamond_fence",
            new FenceBlock(abstractBlockSettings("calcified_diamond_fence", diamondPack)));

    public static final Block CALCIFIED_DIAMOND_FENCE_GATE = registerBlock("calcified_diamond_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_diamond_fence_gate", diamondPack)));

    public static final Block CALCIFIED_DIAMOND_WALL = registerBlock("calcified_diamond_wall",
            new WallBlock(abstractBlockSettings("calcified_diamond_wall", diamondPack)));

    public static final Block POLISHED_DIAMOND_STAIRS = registerBlock("polished_diamond_stairs",
            new StairsBlock(ModBlocks.POLISHED_DIAMOND_BLOCK.getDefaultState(), abstractBlockSettings("polished_diamond_stairs", diamondPack)));

    public static final Block POLISHED_DIAMOND_SLAB = registerBlock("polished_diamond_slab",
            new SlabBlock(abstractBlockSettings("polished_diamond_slab", diamondPack)));

    public static final Block POLISHED_DIAMOND_FENCE = registerBlock("polished_diamond_fence",
            new FenceBlock(abstractBlockSettings("polished_diamond_fence", diamondPack)));

    public static final Block POLISHED_DIAMOND_FENCE_GATE = registerBlock("polished_diamond_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_diamond_fence_gate", diamondPack)));

    public static final Block POLISHED_DIAMOND_WALL = registerBlock("polished_diamond_wall",
            new WallBlock(abstractBlockSettings("polished_diamond_wall", diamondPack)));

    // IRON BLOCKS

    public static final Block IRON_STAIRS = registerBlock("iron_stairs",
            new StairsBlock(Blocks.IRON_BLOCK.getDefaultState(), abstractBlockSettings("iron_stairs", ironPack)));

    public static final Block IRON_SLAB = registerBlock("iron_slab",
            new SlabBlock(abstractBlockSettings("iron_slab", ironPack)));

    public static final Block IRON_FENCE = registerBlock("iron_fence",
            new FenceBlock(abstractBlockSettings("iron_fence", ironPack)));

    public static final Block IRON_FENCE_GATE = registerBlock("iron_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("iron_fence_gate", ironPack)));

    public static final Block IRON_WALL = registerBlock("iron_wall",
            new WallBlock(abstractBlockSettings("iron_wall", ironPack)));

    public static final Block POLISHED_IRON_BLOCK = registerBlock("polished_iron_block",
            new Block(abstractBlockSettings("polished_iron_block", ironPack).instrument(NoteBlockInstrument.IRON_XYLOPHONE)));

    public static final Block CALCIFIED_IRON_BLOCK = registerBlock("calcified_iron_block",
            new Block(abstractBlockSettings("calcified_iron_block", ironPack)));

    public static final Block IRON_BRICKS = registerBlock("iron_bricks",
            new Block(abstractBlockSettings("iron_bricks", ironPack).instrument(NoteBlockInstrument.IRON_XYLOPHONE)));

    public static final Block IRON_BRICK_STAIRS = registerBlock("iron_brick_stairs",
            new StairsBlock(ModBlocks.IRON_BRICKS.getDefaultState(), abstractBlockSettings("iron_brick_stairs", ironPack)));

    public static final Block IRON_BRICK_SLAB = registerBlock("iron_brick_slab",
            new SlabBlock(abstractBlockSettings("iron_brick_slab", ironPack)));

    public static final Block IRON_BRICK_FENCE = registerBlock("iron_brick_fence",
            new FenceBlock(abstractBlockSettings("iron_brick_fence", ironPack)));

    public static final Block IRON_BRICK_FENCE_GATE = registerBlock("iron_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("iron_brick_fence_gate", ironPack)));

    public static final Block IRON_BRICK_WALL = registerBlock("iron_brick_wall",
            new WallBlock(abstractBlockSettings("iron_brick_wall", ironPack)));

    public static final Block CALCIFIED_IRON_STAIRS = registerBlock("calcified_iron_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_IRON_BLOCK.getDefaultState(), abstractBlockSettings("calcified_iron_stairs", ironPack)));

    public static final Block CALCIFIED_IRON_SLAB = registerBlock("calcified_iron_slab",
            new SlabBlock(abstractBlockSettings("calcified_iron_slab", ironPack)));

    public static final Block CALCIFIED_IRON_FENCE = registerBlock("calcified_iron_fence",
            new FenceBlock(abstractBlockSettings("calcified_iron_fence", ironPack)));

    public static final Block CALCIFIED_IRON_FENCE_GATE = registerBlock("calcified_iron_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_iron_fence_gate", ironPack)));

    public static final Block CALCIFIED_IRON_WALL = registerBlock("calcified_iron_wall",
            new WallBlock(abstractBlockSettings("calcified_iron_wall", ironPack)));

    public static final Block POLISHED_IRON_STAIRS = registerBlock("polished_iron_stairs",
            new StairsBlock(ModBlocks.POLISHED_IRON_BLOCK.getDefaultState(), abstractBlockSettings("polished_iron_stairs", ironPack)));

    public static final Block POLISHED_IRON_SLAB = registerBlock("polished_iron_slab",
            new SlabBlock(abstractBlockSettings("polished_iron_slab", ironPack)));

    public static final Block POLISHED_IRON_FENCE = registerBlock("polished_iron_fence",
            new FenceBlock(abstractBlockSettings("polished_iron_fence", ironPack)));

    public static final Block POLISHED_IRON_FENCE_GATE = registerBlock("polished_iron_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_iron_fence_gate", ironPack)));

    public static final Block POLISHED_IRON_WALL = registerBlock("polished_iron_wall",
            new WallBlock(abstractBlockSettings("polished_iron_wall", ironPack)));

    // EMERALD BLOCKS

    public static final Block EMERALD_STAIRS = registerBlock("emerald_stairs",
            new StairsBlock(Blocks.EMERALD_BLOCK.getDefaultState(), abstractBlockSettings("emerald_stairs", emeraldPack)));

    public static final Block EMERALD_SLAB = registerBlock("emerald_slab",
            new SlabBlock(abstractBlockSettings("emerald_slab", emeraldPack)));

    public static final Block EMERALD_FENCE = registerBlock("emerald_fence",
            new FenceBlock(abstractBlockSettings("emerald_fence", emeraldPack)));

    public static final Block EMERALD_FENCE_GATE = registerBlock("emerald_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("emerald_fence_gate", emeraldPack)));

    public static final Block EMERALD_WALL = registerBlock("emerald_wall",
            new WallBlock(abstractBlockSettings("emerald_wall", emeraldPack)));

    public static final Block EMERALD_DOOR = registerBlock("emerald_door",
            new DoorBlock(BlockSetType.OAK, abstractBlockSettings("emerald_door", emeraldPack).nonOpaque()));

    public static final Block EMERALD_TRAPDOOR = registerBlock("emerald_trapdoor",
            new TrapdoorBlock(BlockSetType.OAK, abstractBlockSettings("emerald_trapdoor", emeraldPack).nonOpaque()));

    public static final Block POLISHED_EMERALD_BLOCK = registerBlock("polished_emerald_block",
            new Block(abstractBlockSettings("polished_emerald_block", emeraldPack).instrument(NoteBlockInstrument.BIT)));

    public static final Block CALCIFIED_EMERALD_BLOCK = registerBlock("calcified_emerald_block",
            new Block(abstractBlockSettings("calcified_emerald_block", emeraldPack)));

    public static final Block EMERALD_BRICKS = registerBlock("emerald_bricks",
            new Block(abstractBlockSettings("emerald_bricks", emeraldPack).instrument(NoteBlockInstrument.BIT)));

    public static final Block CHISELED_EMERALD_BLOCK = registerBlock("chiseled_emerald_block",
            new Block(abstractBlockSettings("chiseled_emerald_block", emeraldPack).instrument(NoteBlockInstrument.BIT)));

    public static final Block EMERALD_BRICK_STAIRS = registerBlock("emerald_brick_stairs",
            new StairsBlock(ModBlocks.EMERALD_BRICKS.getDefaultState(), abstractBlockSettings("emerald_brick_stairs", emeraldPack)));

    public static final Block EMERALD_BRICK_SLAB = registerBlock("emerald_brick_slab",
            new SlabBlock(abstractBlockSettings("emerald_brick_slab", emeraldPack)));

    public static final Block EMERALD_BRICK_FENCE = registerBlock("emerald_brick_fence",
            new FenceBlock(abstractBlockSettings("emerald_brick_fence", emeraldPack)));

    public static final Block EMERALD_BRICK_FENCE_GATE = registerBlock("emerald_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("emerald_brick_fence_gate", emeraldPack)));

    public static final Block EMERALD_BRICK_WALL = registerBlock("emerald_brick_wall",
            new WallBlock(abstractBlockSettings("emerald_brick_wall", emeraldPack)));

    public static final Block CALCIFIED_EMERALD_STAIRS = registerBlock("calcified_emerald_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_EMERALD_BLOCK.getDefaultState(), abstractBlockSettings("calcified_emerald_stairs", emeraldPack)));

    public static final Block CALCIFIED_EMERALD_SLAB = registerBlock("calcified_emerald_slab",
            new SlabBlock(abstractBlockSettings("calcified_emerald_slab", emeraldPack)));

    public static final Block CALCIFIED_EMERALD_FENCE = registerBlock("calcified_emerald_fence",
            new FenceBlock(abstractBlockSettings("calcified_emerald_fence", emeraldPack)));

    public static final Block CALCIFIED_EMERALD_FENCE_GATE = registerBlock("calcified_emerald_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_emerald_fence_gate", emeraldPack)));

    public static final Block CALCIFIED_EMERALD_WALL = registerBlock("calcified_emerald_wall",
            new WallBlock(abstractBlockSettings("calcified_emerald_wall", emeraldPack)));

    public static final Block POLISHED_EMERALD_STAIRS = registerBlock("polished_emerald_stairs",
            new StairsBlock(ModBlocks.POLISHED_EMERALD_BLOCK.getDefaultState(), abstractBlockSettings("polished_emerald_stairs", emeraldPack)));

    public static final Block POLISHED_EMERALD_SLAB = registerBlock("polished_emerald_slab",
            new SlabBlock(abstractBlockSettings("polished_emerald_slab", emeraldPack)));

    public static final Block POLISHED_EMERALD_FENCE = registerBlock("polished_emerald_fence",
            new FenceBlock(abstractBlockSettings("polished_emerald_fence", emeraldPack)));

    public static final Block POLISHED_EMERALD_FENCE_GATE = registerBlock("polished_emerald_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_emerald_fence_gate", emeraldPack)));

    public static final Block POLISHED_EMERALD_WALL = registerBlock("polished_emerald_wall",
            new WallBlock(abstractBlockSettings("polished_emerald_wall", emeraldPack)));

    public static final Block CHISELED_EMERALD_STAIRS = registerBlock("chiseled_emerald_stairs",
            new StairsBlock(ModBlocks.CHISELED_EMERALD_BLOCK.getDefaultState(), abstractBlockSettings("chiseled_emerald_stairs", emeraldPack)));

    public static final Block CHISELED_EMERALD_SLAB = registerBlock("chiseled_emerald_slab",
            new SlabBlock(abstractBlockSettings("chiseled_emerald_slab", emeraldPack)));

    public static final Block CHISELED_EMERALD_FENCE = registerBlock("chiseled_emerald_fence",
            new FenceBlock(abstractBlockSettings("chiseled_emerald_fence", emeraldPack)));

    public static final Block CHISELED_EMERALD_FENCE_GATE = registerBlock("chiseled_emerald_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("chiseled_emerald_fence_gate", emeraldPack)));

    public static final Block CHISELED_EMERALD_WALL = registerBlock("chiseled_emerald_wall",
            new WallBlock(abstractBlockSettings("chiseled_emerald_wall", emeraldPack)));

    // AMETHYST BLOCKS

    public static final Block AMETHYST_STAIRS = registerBlock("amethyst_stairs",
            new StairsBlock(Blocks.AMETHYST_BLOCK.getDefaultState(), abstractBlockSettings("amethyst_stairs", amethystPack)));

    public static final Block AMETHYST_SLAB = registerBlock("amethyst_slab",
            new SlabBlock(abstractBlockSettings("amethyst_slab", amethystPack)));

    public static final Block AMETHYST_FENCE = registerBlock("amethyst_fence",
            new FenceBlock(abstractBlockSettings("amethyst_fence", amethystPack)));

    public static final Block AMETHYST_FENCE_GATE = registerBlock("amethyst_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("amethyst_fence_gate", amethystPack)));

    public static final Block AMETHYST_WALL = registerBlock("amethyst_wall",
            new WallBlock(abstractBlockSettings("amethyst_wall", amethystPack)));

    public static final Block AMETHYST_DOOR = registerBlock("amethyst_door",
            new DoorBlock(BlockSetType.OAK, abstractBlockSettings("amethyst_door", amethystPack).nonOpaque()));

    public static final Block AMETHYST_TRAPDOOR = registerBlock("amethyst_trapdoor",
            new TrapdoorBlock(BlockSetType.OAK, abstractBlockSettings("amethyst_trapdoor", amethystPack).nonOpaque()));

    public static final Block POLISHED_AMETHYST_BLOCK = registerBlock("polished_amethyst_block",
            new Block(abstractBlockSettings("polished_amethyst_block", amethystPack)));

    public static final Block CALCIFIED_AMETHYST_BLOCK = registerBlock("calcified_amethyst_block",
            new Block(abstractBlockSettings("calcified_amethyst_block", amethystPack)));

    public static final Block AMETHYST_BRICKS = registerBlock("amethyst_bricks",
            new Block(abstractBlockSettings("amethyst_bricks", amethystPack)));

    public static final Block AMETHYST_BRICK_STAIRS = registerBlock("amethyst_brick_stairs",
            new StairsBlock(ModBlocks.AMETHYST_BRICKS.getDefaultState(), abstractBlockSettings("amethyst_brick_stairs", amethystPack)));

    public static final Block AMETHYST_BRICK_SLAB = registerBlock("amethyst_brick_slab",
            new SlabBlock(abstractBlockSettings("amethyst_brick_slab", amethystPack)));

    public static final Block AMETHYST_BRICK_FENCE = registerBlock("amethyst_brick_fence",
            new FenceBlock(abstractBlockSettings("amethyst_brick_fence", amethystPack)));

    public static final Block AMETHYST_BRICK_FENCE_GATE = registerBlock("amethyst_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("amethyst_brick_fence_gate", amethystPack)));

    public static final Block AMETHYST_BRICK_WALL = registerBlock("amethyst_brick_wall",
            new WallBlock(abstractBlockSettings("amethyst_brick_wall", amethystPack)));

    public static final Block CALCIFIED_AMETHYST_STAIRS = registerBlock("calcified_amethyst_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_AMETHYST_BLOCK.getDefaultState(), abstractBlockSettings("calcified_amethyst_stairs", amethystPack)));

    public static final Block CALCIFIED_AMETHYST_SLAB = registerBlock("calcified_amethyst_slab",
            new SlabBlock(abstractBlockSettings("calcified_amethyst_slab", amethystPack)));

    public static final Block CALCIFIED_AMETHYST_FENCE = registerBlock("calcified_amethyst_fence",
            new FenceBlock(abstractBlockSettings("calcified_amethyst_fence", amethystPack)));

    public static final Block CALCIFIED_AMETHYST_FENCE_GATE = registerBlock("calcified_amethyst_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_amethyst_fence_gate", amethystPack)));

    public static final Block CALCIFIED_AMETHYST_WALL = registerBlock("calcified_amethyst_wall",
            new WallBlock(abstractBlockSettings("calcified_amethyst_wall", amethystPack)));

    public static final Block POLISHED_AMETHYST_STAIRS = registerBlock("polished_amethyst_stairs",
            new StairsBlock(ModBlocks.POLISHED_AMETHYST_BLOCK.getDefaultState(), abstractBlockSettings("polished_amethyst_stairs", amethystPack)));

    public static final Block POLISHED_AMETHYST_SLAB = registerBlock("polished_amethyst_slab",
            new SlabBlock(abstractBlockSettings("polished_amethyst_slab", amethystPack)));

    public static final Block POLISHED_AMETHYST_FENCE = registerBlock("polished_amethyst_fence",
            new FenceBlock(abstractBlockSettings("polished_amethyst_fence", amethystPack)));

    public static final Block POLISHED_AMETHYST_FENCE_GATE = registerBlock("polished_amethyst_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_amethyst_fence_gate", amethystPack)));

    public static final Block POLISHED_AMETHYST_WALL = registerBlock("polished_amethyst_wall",
            new WallBlock(abstractBlockSettings("polished_amethyst_wall", amethystPack)));


    // LAPIS LAZULI BLOCKS

    public static final Block LAPIS_STAIRS = registerBlock("lapis_stairs",
            new StairsBlock(Blocks.LAPIS_BLOCK.getDefaultState(), abstractBlockSettings("lapis_stairs", lapisPack)));

    public static final Block LAPIS_SLAB = registerBlock("lapis_slab",
            new SlabBlock(abstractBlockSettings("lapis_slab", lapisPack)));

    public static final Block LAPIS_FENCE = registerBlock("lapis_fence",
            new FenceBlock(abstractBlockSettings("lapis_fence", lapisPack)));

    public static final Block LAPIS_FENCE_GATE = registerBlock("lapis_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("lapis_fence_gate", lapisPack)));

    public static final Block LAPIS_WALL = registerBlock("lapis_wall",
            new WallBlock(abstractBlockSettings("lapis_wall", lapisPack)));

    public static final Block LAPIS_DOOR = registerBlock("lapis_door",
            new DoorBlock(BlockSetType.OAK, abstractBlockSettings("lapis_door", lapisPack).nonOpaque()));

    public static final Block LAPIS_TRAPDOOR = registerBlock("lapis_trapdoor",
            new TrapdoorBlock(BlockSetType.OAK, abstractBlockSettings("lapis_trapdoor", lapisPack).nonOpaque()));

    public static final Block POLISHED_LAPIS_BLOCK = registerBlock("polished_lapis_block",
            new Block(abstractBlockSettings("polished_lapis_block", lapisPack)));

    public static final Block CALCIFIED_LAPIS_BLOCK = registerBlock("calcified_lapis_block",
            new Block(abstractBlockSettings("calcified_lapis_block", lapisPack)));

    public static final Block LAPIS_BRICKS = registerBlock("lapis_bricks",
            new Block(abstractBlockSettings("lapis_bricks", lapisPack)));

    public static final Block LAPIS_BRICK_STAIRS = registerBlock("lapis_brick_stairs",
            new StairsBlock(ModBlocks.LAPIS_BRICKS.getDefaultState(), abstractBlockSettings("lapis_brick_stairs", lapisPack)));

    public static final Block LAPIS_BRICK_SLAB = registerBlock("lapis_brick_slab",
            new SlabBlock(abstractBlockSettings("lapis_brick_slab", lapisPack)));

    public static final Block LAPIS_BRICK_FENCE = registerBlock("lapis_brick_fence",
            new FenceBlock(abstractBlockSettings("lapis_brick_fence", lapisPack)));

    public static final Block LAPIS_BRICK_FENCE_GATE = registerBlock("lapis_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("lapis_brick_fence_gate", lapisPack)));

    public static final Block LAPIS_BRICK_WALL = registerBlock("lapis_brick_wall",
            new WallBlock(abstractBlockSettings("lapis_brick_wall", lapisPack)));

    public static final Block CALCIFIED_LAPIS_STAIRS = registerBlock("calcified_lapis_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_LAPIS_BLOCK.getDefaultState(), abstractBlockSettings("calcified_lapis_stairs", lapisPack)));

    public static final Block CALCIFIED_LAPIS_SLAB = registerBlock("calcified_lapis_slab",
            new SlabBlock(abstractBlockSettings("calcified_lapis_slab", lapisPack)));

    public static final Block CALCIFIED_LAPIS_FENCE = registerBlock("calcified_lapis_fence",
            new FenceBlock(abstractBlockSettings("calcified_lapis_fence", lapisPack)));

    public static final Block CALCIFIED_LAPIS_FENCE_GATE = registerBlock("calcified_lapis_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_lapis_fence_gate", lapisPack)));

    public static final Block CALCIFIED_LAPIS_WALL = registerBlock("calcified_lapis_wall",
            new WallBlock(abstractBlockSettings("calcified_lapis_wall", lapisPack)));

    public static final Block POLISHED_LAPIS_STAIRS = registerBlock("polished_lapis_stairs",
            new StairsBlock(ModBlocks.POLISHED_LAPIS_BLOCK.getDefaultState(), abstractBlockSettings("polished_lapis_stairs", lapisPack)));

    public static final Block POLISHED_LAPIS_SLAB = registerBlock("polished_lapis_slab",
            new SlabBlock(abstractBlockSettings("polished_lapis_slab", lapisPack)));

    public static final Block POLISHED_LAPIS_FENCE = registerBlock("polished_lapis_fence",
            new FenceBlock(abstractBlockSettings("polished_lapis_fence", lapisPack)));

    public static final Block POLISHED_LAPIS_FENCE_GATE = registerBlock("polished_lapis_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_lapis_fence_gate", lapisPack)));

    public static final Block POLISHED_LAPIS_WALL = registerBlock("polished_lapis_wall",
            new WallBlock(abstractBlockSettings("polished_lapis_wall", lapisPack)));

    // COAL BLOCKS

    public static final Block COAL_STAIRS = registerBlock("coal_stairs",
            new StairsBlock(Blocks.COAL_BLOCK.getDefaultState(), abstractBlockSettings("coal_stairs", coalPack)));

    public static final Block COAL_SLAB = registerBlock("coal_slab",
            new SlabBlock(abstractBlockSettings("coal_slab", coalPack)));

    public static final Block COAL_FENCE = registerBlock("coal_fence",
            new FenceBlock(abstractBlockSettings("coal_fence", coalPack)));

    public static final Block COAL_FENCE_GATE = registerBlock("coal_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("coal_fence_gate", coalPack)));

    public static final Block COAL_WALL = registerBlock("coal_wall",
            new WallBlock(abstractBlockSettings("coal_wall", coalPack)));

    public static final Block COAL_DOOR = registerBlock("coal_door",
            new DoorBlock(BlockSetType.OAK, abstractBlockSettings("coal_door", coalPack).nonOpaque()));

    public static final Block COAL_TRAPDOOR = registerBlock("coal_trapdoor",
            new TrapdoorBlock(BlockSetType.OAK, abstractBlockSettings("coal_trapdoor", coalPack).nonOpaque()));

    public static final Block POLISHED_COAL_BLOCK = registerBlock("polished_coal_block",
            new Block(abstractBlockSettings("polished_coal_block", coalPack).instrument(NoteBlockInstrument.BASEDRUM)));

    public static final Block CALCIFIED_COAL_BLOCK = registerBlock("calcified_coal_block",
            new Block(abstractBlockSettings("calcified_coal_block", coalPack)));

    public static final Block COAL_BRICKS = registerBlock("coal_bricks",
            new Block(abstractBlockSettings("coal_bricks", coalPack).instrument(NoteBlockInstrument.BASEDRUM)));

    public static final Block COAL_BRICK_STAIRS = registerBlock("coal_brick_stairs",
            new StairsBlock(ModBlocks.COAL_BRICKS.getDefaultState(), abstractBlockSettings("coal_brick_stairs", coalPack)));

    public static final Block COAL_BRICK_SLAB = registerBlock("coal_brick_slab",
            new SlabBlock(abstractBlockSettings("coal_brick_slab", coalPack)));

    public static final Block COAL_BRICK_FENCE = registerBlock("coal_brick_fence",
            new FenceBlock(abstractBlockSettings("coal_brick_fence", coalPack)));

    public static final Block COAL_BRICK_FENCE_GATE = registerBlock("coal_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("coal_brick_fence_gate", coalPack)));

    public static final Block COAL_BRICK_WALL = registerBlock("coal_brick_wall",
            new WallBlock(abstractBlockSettings("coal_brick_wall", coalPack)));

    public static final Block CALCIFIED_COAL_STAIRS = registerBlock("calcified_coal_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_COAL_BLOCK.getDefaultState(), abstractBlockSettings("calcified_coal_stairs", coalPack)));

    public static final Block CALCIFIED_COAL_SLAB = registerBlock("calcified_coal_slab",
            new SlabBlock(abstractBlockSettings("calcified_coal_slab", coalPack)));

    public static final Block CALCIFIED_COAL_FENCE = registerBlock("calcified_coal_fence",
            new FenceBlock(abstractBlockSettings("calcified_coal_fence", coalPack)));

    public static final Block CALCIFIED_COAL_FENCE_GATE = registerBlock("calcified_coal_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_coal_fence_gate", coalPack)));

    public static final Block CALCIFIED_COAL_WALL = registerBlock("calcified_coal_wall",
            new WallBlock(abstractBlockSettings("calcified_coal_wall", coalPack)));

    public static final Block POLISHED_COAL_STAIRS = registerBlock("polished_coal_stairs",
            new StairsBlock(ModBlocks.POLISHED_COAL_BLOCK.getDefaultState(), abstractBlockSettings("polished_coal_stairs", coalPack)));

    public static final Block POLISHED_COAL_SLAB = registerBlock("polished_coal_slab",
            new SlabBlock(abstractBlockSettings("polished_coal_slab", coalPack)));

    public static final Block POLISHED_COAL_FENCE = registerBlock("polished_coal_fence",
            new FenceBlock(abstractBlockSettings("polished_coal_fence", coalPack)));

    public static final Block POLISHED_COAL_FENCE_GATE = registerBlock("polished_coal_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_coal_fence_gate", coalPack)));

    public static final Block POLISHED_COAL_WALL = registerBlock("polished_coal_wall",
            new WallBlock(abstractBlockSettings("polished_coal_wall", coalPack)));

    // CALCITE BLOCKS

    public static final Block CALCITE_STAIRS = registerBlock("calcite_stairs",
            new StairsBlock(Blocks.CALCITE.getDefaultState(), abstractBlockSettings("calcite_stairs", calcitePack)));

    public static final Block CALCITE_SLAB = registerBlock("calcite_slab",
            new SlabBlock(abstractBlockSettings("calcite_slab", calcitePack)));

    public static final Block CALCITE_FENCE = registerBlock("calcite_fence",
            new FenceBlock(abstractBlockSettings("calcite_fence", calcitePack)));

    public static final Block CALCITE_FENCE_GATE = registerBlock("calcite_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcite_fence_gate", calcitePack)));

    public static final Block CALCITE_WALL = registerBlock("calcite_wall",
            new WallBlock(abstractBlockSettings("calcite_wall", calcitePack)));

    // NETHERITE BLOCKS

    public static final Block NETHERITE_STAIRS = registerBlock("netherite_stairs",
            new StairsBlock(Blocks.NETHERITE_BLOCK.getDefaultState(), abstractBlockSettings("netherite_stairs", netheritePack)));

    public static final Block NETHERITE_SLAB = registerBlock("netherite_slab",
            new SlabBlock(abstractBlockSettings("netherite_slab", netheritePack)));

    public static final Block NETHERITE_FENCE = registerBlock("netherite_fence",
            new FenceBlock(abstractBlockSettings("netherite_fence", netheritePack)));

    public static final Block NETHERITE_FENCE_GATE = registerBlock("netherite_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("netherite_fence_gate", netheritePack)));
    ...
    public static final Block CALCIFIED_NETHERITE_BLOCK = registerBlock("calcified_netherite_block",
            new Block(abstractBlockSettings("calcified_netherite_block", netheritePack)));

    public static final Block NETHERITE_BRICKS = registerBlock("netherite_bricks",
            new Block(abstractBlockSettings("netherite_bricks", netheritePack).instrument(NoteBlockInstrument.BASEDRUM)));

    public static final Block NETHERITE_BRICK_STAIRS = registerBlock("netherite_brick_stairs",
            new StairsBlock(ModBlocks.NETHERITE_BRICKS.getDefaultState(), abstractBlockSettings("netherite_brick_stairs", netheritePack)));

    public static final Block NETHERITE_BRICK_SLAB = registerBlock("netherite_brick_slab",
            new SlabBlock(abstractBlockSettings("netherite_brick_slab", netheritePack)));

    public static final Block NETHERITE_BRICK_FENCE = registerBlock("netherite_brick_fence",
            new FenceBlock(abstractBlockSettings("netherite_brick_fence", netheritePack)));

    public static final Block NETHERITE_BRICK_FENCE_GATE = registerBlock("netherite_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("netherite_brick_fence_gate", netheritePack)));

    public static final Block NETHERITE_BRICK_WALL = registerBlock("netherite_brick_wall",
            new WallBlock(abstractBlockSettings("netherite_brick_wall", netheritePack)));

    public static final Block CALCIFIED_NETHERITE_STAIRS = registerBlock("calcified_netherite_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_NETHERITE_BLOCK.getDefaultState(), abstractBlockSettings("calcified_netherite_stairs", netheritePack)));

    public static final Block CALCIFIED_NETHERITE_SLAB = registerBlock("calcified_netherite_slab",
            new SlabBlock(abstractBlockSettings("calcified_netherite_slab", netheritePack)));

    public static final Block CALCIFIED_NETHERITE_FENCE = registerBlock("calcified_netherite_fence",
            new FenceBlock(abstractBlockSettings("calcified_netherite_fence", netheritePack)));

    public static final Block CALCIFIED_NETHERITE_FENCE_GATE = registerBlock("calcified_netherite_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_netherite_fence_gate", netheritePack)));

    public static final Block CALCIFIED_NETHERITE_WALL = registerBlock("calcified_netherite_wall",
            new WallBlock(abstractBlockSettings("calcified_netherite_wall", netheritePack)));

    public static final Block POLISHED_NETHERITE_STAIRS = registerBlock("polished_netherite_stairs",
            new StairsBlock(ModBlocks.POLISHED_NETHERITE_BLOCK.getDefaultState(), abstractBlockSettings("polished_netherite_stairs", netheritePack)));

    public static final Block POLISHED_NETHERITE_SLAB = registerBlock("polished_netherite_slab",
            new SlabBlock(abstractBlockSettings("polished_netherite_slab", netheritePack)));

    public static final Block POLISHED_NETHERITE_FENCE = registerBlock("polished_netherite_fence",
            new FenceBlock(abstractBlockSettings("polished_netherite_fence", netheritePack)));

    public static final Block POLISHED_NETHERITE_FENCE_GATE = registerBlock("polished_netherite_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_netherite_fence_gate", netheritePack)));

    public static final Block POLISHED_NETHERITE_WALL = registerBlock("polished_netherite_wall",
            new WallBlock(abstractBlockSettings("polished_netherite_wall", netheritePack)));

    // REDSTONE

    public static final Block REDSTONE_STAIRS = registerBlock("redstone_stairs",
            new StairsBlock(Blocks.REDSTONE_BLOCK.getDefaultState(), abstractBlockSettings("redstone_stairs", redstonePack)));

    public static final Block REDSTONE_SLAB = registerBlock("redstone_slab",
            new SlabBlock(abstractBlockSettings("redstone_slab", redstonePack)));

    public static final Block REDSTONE_FENCE = registerBlock("redstone_fence",
            new FenceBlock(abstractBlockSettings("redstone_fence", redstonePack)));

    public static final Block REDSTONE_FENCE_GATE = registerBlock("redstone_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("redstone_fence_gate", redstonePack)));

    public static final Block REDSTONE_WALL = registerBlock("redstone_wall",
            new WallBlock(abstractBlockSettings("redstone_wall", redstonePack)));

    public static final Block REDSTONE_DOOR = registerBlock("redstone_door",
            new DoorBlock(BlockSetType.OAK, abstractBlockSettings("redstone_door", redstonePack).nonOpaque()));

    public static final Block REDSTONE_TRAPDOOR = registerBlock("redstone_trapdoor",
            new TrapdoorBlock(BlockSetType.OAK, abstractBlockSettings("redstone_trapdoor", redstonePack).nonOpaque()));

    public static final Block POLISHED_REDSTONE_BLOCK = registerBlock("polished_redstone_block",
            new Block(abstractBlockSettings("polished_redstone_block", redstonePack).instrument(NoteBlockInstrument.BASEDRUM)));

    public static final Block CALCIFIED_REDSTONE_BLOCK = registerBlock("calcified_redstone_block",
            new Block(abstractBlockSettings("calcified_redstone_block", redstonePack)));

    public static final Block REDSTONE_BRICKS = registerBlock("redstone_bricks",
            new Block(abstractBlockSettings("redstone_bricks", redstonePack).instrument(NoteBlockInstrument.BASEDRUM)));

    public static final Block REDSTONE_BRICK_STAIRS = registerBlock("redstone_brick_stairs",
            new StairsBlock(ModBlocks.REDSTONE_BRICKS.getDefaultState(), abstractBlockSettings("redstone_brick_stairs", redstonePack)));

    public static final Block REDSTONE_BRICK_SLAB = registerBlock("redstone_brick_slab",
            new SlabBlock(abstractBlockSettings("redstone_brick_slab", redstonePack)));

    public static final Block REDSTONE_BRICK_FENCE = registerBlock("redstone_brick_fence",
            new FenceBlock(abstractBlockSettings("redstone_brick_fence", redstonePack)));

    public static final Block REDSTONE_BRICK_FENCE_GATE = registerBlock("redstone_brick_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("redstone_brick_fence_gate", redstonePack)));

    public static final Block REDSTONE_BRICK_WALL = registerBlock("redstone_brick_wall",
            new WallBlock(abstractBlockSettings("redstone_brick_wall", redstonePack)));

    public static final Block CALCIFIED_REDSTONE_STAIRS = registerBlock("calcified_redstone_stairs",
            new StairsBlock(ModBlocks.CALCIFIED_REDSTONE_BLOCK.getDefaultState(), abstractBlockSettings("calcified_redstone_stairs", redstonePack)));

    public static final Block CALCIFIED_REDSTONE_SLAB = registerBlock("calcified_redstone_slab",
            new SlabBlock(abstractBlockSettings("calcified_redstone_slab", redstonePack)));

    public static final Block CALCIFIED_REDSTONE_FENCE = registerBlock("calcified_redstone_fence",
            new FenceBlock(abstractBlockSettings("calcified_redstone_fence", redstonePack)));

    public static final Block CALCIFIED_REDSTONE_FENCE_GATE = registerBlock("calcified_redstone_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("calcified_redstone_fence_gate", redstonePack)));

    public static final Block CALCIFIED_REDSTONE_WALL = registerBlock("calcified_redstone_wall",
            new WallBlock(abstractBlockSettings("calcified_redstone_wall", redstonePack)));

    public static final Block POLISHED_REDSTONE_STAIRS = registerBlock("polished_redstone_stairs",
            new StairsBlock(ModBlocks.POLISHED_REDSTONE_BLOCK.getDefaultState(), abstractBlockSettings("polished_redstone_stairs", redstonePack)));

    public static final Block POLISHED_REDSTONE_SLAB = registerBlock("polished_redstone_slab",
            new SlabBlock(abstractBlockSettings("polished_redstone_slab", redstonePack)));

    public static final Block POLISHED_REDSTONE_FENCE = registerBlock("polished_redstone_fence",
            new FenceBlock(abstractBlockSettings("polished_redstone_fence", redstonePack)));

    public static final Block POLISHED_REDSTONE_FENCE_GATE = registerBlock("polished_redstone_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("polished_redstone_fence_gate", redstonePack)));

    public static final Block POLISHED_REDSTONE_WALL = registerBlock("polished_redstone_wall",
            new WallBlock(abstractBlockSettings("polished_redstone_wall", redstonePack)));

    // OBSIDIAN

    public static final Block OBSIDIAN_STAIRS = registerBlock("obsidian_stairs",
            new StairsBlock(Blocks.OBSIDIAN.getDefaultState(), abstractBlockSettings("obsidian_stairs", obsidianPack)));

    public static final Block OBSIDIAN_SLAB = registerBlock("obsidian_slab",
            new SlabBlock(abstractBlockSettings("obsidian_slab", obsidianPack)));

    public static final Block OBSIDIAN_FENCE = registerBlock("obsidian_fence",
            new FenceBlock(abstractBlockSettings("obsidian_fence", obsidianPack)));

    public static final Block OBSIDIAN_FENCE_GATE = registerBlock("obsidian_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("obsidian_fence_gate", obsidianPack)));

    public static final Block OBSIDIAN_WALL = registerBlock("obsidian_wall",
            new WallBlock(abstractBlockSettings("obsidian_wall", obsidianPack)));

    // BEDROCK

    public static final Block BEDROCK_STAIRS = registerBlock("bedrock_stairs",
            new StairsBlock(Blocks.BEDROCK.getDefaultState(), abstractBlockSettings("bedrock_stairs", bedrockPack).strength(-1F).dropsNothing().allowsSpawning(Blocks::never)));

    public static final Block BEDROCK_SLAB = registerBlock("bedrock_slab",
            new SlabBlock(abstractBlockSettings("bedrock_slab", bedrockPack).strength(-1F).dropsNothing().allowsSpawning(Blocks::never)));

    public static final Block BEDROCK_FENCE = registerBlock("bedrock_fence",
            new FenceBlock(abstractBlockSettings("bedrock_fence", bedrockPack).strength(-1F).dropsNothing().allowsSpawning(Blocks::never)));

    public static final Block BEDROCK_FENCE_GATE = registerBlock("bedrock_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("bedrock_fence_gate", bedrockPack).strength(-1F).dropsNothing().allowsSpawning(Blocks::never)));

    public static final Block BEDROCK_WALL = registerBlock("bedrock_wall",
            new WallBlock(abstractBlockSettings("bedrock_wall", bedrockPack).strength(-1F).dropsNothing().allowsSpawning(Blocks::never)));

    // SCULK

    //TODO add drop table con silk touch unicamente
    public static final Block SCULK_STAIRS = registerBlock("sculk_stairs",
            new StairsBlock(Blocks.SCULK.getDefaultState(), abstractBlockSettings("sculk_stairs", sculkPack)));

    public static final Block SCULK_SLAB = registerBlock("sculk_slab",
            new SlabBlock(abstractBlockSettings("sculk_slab", sculkPack)));

    public static final Block SCULK_FENCE = registerBlock("sculk_fence",
            new FenceBlock(abstractBlockSettings("sculk_fence", sculkPack)));

    public static final Block SCULK_FENCE_GATE = registerBlock("sculk_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("sculk_fence_gate", sculkPack)));

    public static final Block SCULK_WALL = registerBlock("sculk_wall",
            new WallBlock(abstractBlockSettings("sculk_wall", sculkPack)));

    // PACKED_ICE

    public static final Block PACKED_ICE_STAIRS = registerBlock("packed_ice_stairs",
            new StairsBlock(Blocks.PACKED_ICE.getDefaultState(), abstractBlockSettings("packed_ice_stairs", packedIcePack).instrument(NoteBlockInstrument.CHIME).slipperiness(0.98F)));

    public static final Block PACKED_ICE_SLAB = registerBlock("packed_ice_slab",
            new SlabBlock(abstractBlockSettings("packed_ice_slab", packedIcePack).instrument(NoteBlockInstrument.CHIME).slipperiness(0.98F)));

    public static final Block PACKED_ICE_FENCE = registerBlock("packed_ice_fence",
            new FenceBlock(abstractBlockSettings("packed_ice_fence", packedIcePack).instrument(NoteBlockInstrument.CHIME).slipperiness(0.98F)));

    public static final Block PACKED_ICE_FENCE_GATE = registerBlock("packed_ice_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("packed_ice_fence_gate", packedIcePack).instrument(NoteBlockInstrument.CHIME).slipperiness(0.98F)));

    public static final Block PACKED_ICE_WALL = registerBlock("packed_ice_wall",
            new WallBlock(abstractBlockSettings("packed_ice_wall", packedIcePack).instrument(NoteBlockInstrument.CHIME).slipperiness(0.98F)));

    // BLUE_ICE

    public static final Block BLUE_ICE_STAIRS = registerBlock("blue_ice_stairs",
            new StairsBlock(Blocks.BLUE_ICE.getDefaultState(), abstractBlockSettings("blue_ice_stairs", blueIcePack).slipperiness(0.989F)));

    public static final Block BLUE_ICE_SLAB = registerBlock("blue_ice_slab",
            new SlabBlock(abstractBlockSettings("blue_ice_slab", blueIcePack).slipperiness(0.989F)));

    public static final Block BLUE_ICE_FENCE = registerBlock("blue_ice_fence",
            new FenceBlock(abstractBlockSettings("blue_ice_fence", blueIcePack).slipperiness(0.989F)));

    public static final Block BLUE_ICE_FENCE_GATE = registerBlock("blue_ice_fence_gate",
            new FenceGateBlock(WoodType.OAK, abstractBlockSettings("blue_ice_fence_gate", blueIcePack).slipperiness(0.989F)));

    public static final Block BLUE_ICE_WALL = registerBlock("blue_ice_wall",
            new WallBlock(abstractBlockSettings("blue_ice_wall", blueIcePack).slipperiness(0.989F)));

    // ICE

    public static final Block ICE_STAIRS = registerBlock("ice_stairs",
            new StairsBlock(Blocks.ICE.getDefaultState(), abstractBlockSettings("ice_stairs", icePack).slipperiness(0.98F)));

    public static final Block ICE_SLAB = registerBlock("ice_slab",
            new SlabBlock(abstractBlockSettings("ice_slab", icePack).slipperiness(0.98F)));

    public static final Block ICE_FENCE = registerBlock("ice_fence",
            new FenceBlock(abstractBlockSettings("ice_fence", icePack).slipperiness(0.98F)));

    public static final Block ICE_FENCE_GATE = registerBlock("ice_fence_gate",
            new FenceGateBlock(WoodType.ACACIA, abstractBlockSettings("ice_fence_gate", icePack).slipperiness(0.98F)));

    public static final Block ICE_WALL = registerBlock("ice_wall",
            new WallBlock(abstractBlockSettings("ice_wall", icePack).slipperiness(0.98F)));

    // DEEPSLATE_EMERALD_ORE

    public static final Block DEEPSLATE_EMERALD_ORE_STAIRS = registerBlock("deepslate_emerald_ore_stairs",
            new StairsBlock(Blocks.DEEPSLATE_EMERALD_ORE.getDefaultState(), abstractBlockSettings("deepslate_emerald_ore_stairs", deepslateEmeraldOrePack)));

    public static final Block DEEPSLATE_EMERALD_ORE_SLAB = registerBlock("deepslate_emerald_ore_slab",
            new SlabBlock(abstractBlockSettings("deepslate_emerald_ore_slab", deepslateEmeraldOrePack)));

    public static final Block DEEPSLATE_EMERALD_ORE_FENCE = registerBlock("deepslate_emerald_ore_fence",
            new FenceBlock(abstractBlockSettings("deepslate_emerald_ore_fence", deepslateEmeraldOrePack)));

    public static final Block DEEPSLATE_EMERALD_ORE_FENCE_GATE = registerBlock("deepslate_emerald_ore_fence_gate",
            new FenceGateBlock(WoodType.ACACIA, abstractBlockSettings("deepslate_emerald_ore_fence_gate", deepslateEmeraldOrePack)));

    public static final Block DEEPSLATE_EMERALD_ORE_WALL = registerBlock("deepslate_emerald_ore_wall",
            new WallBlock(abstractBlockSettings("deepslate_emerald_ore_wall", deepslateEmeraldOrePack)));

    // PRISMARINE

    public static final Block PRISMARINE_BRICK_WALL = registerBlock("prismarine_brick_wall",
            new WallBlock(abstractBlockSettings("prismarine_brick_wall", prismarinePack)));

    public static final Block DARK_PRISMARINE_WALL = registerBlock("dark_prismarine_wall",
            new WallBlock(abstractBlockSettings("dark_prismarine_wall", prismarinePack)));

    // Others

    public static final Block PROTECTOR_BLOCK = registerBlock("protector_block", new ProtectorBlock(abstractBlockSettings("protector_block").strength(4f, 6f).requiresTool()));
