...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                offerBlasting(List.of(Blocks.COBBLESTONE), RecipeCategory.BUILDING_BLOCKS, Blocks.STONE, 0.10F, 100, "stone");
                offerBlasting(List.of(Blocks.NETHERRACK), RecipeCategory.BUILDING_BLOCKS, Items.NETHER_BRICK, 0.10F, 100, "nether_brick");
                ...
                goldPack.createPackRecipes(this, exporter);
                ...
                goldBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedGoldPack.createPackRecipes(this, exporter);
                ...
                polishedGoldPack.createPackRecipes(this, exporter);

                DoorPack goldDoorPack = new DoorPack(ModBlocks.GOLD_TRAPDOOR, ModBlocks.GOLD_DOOR, Items.GOLD_INGOT, Items.GOLD_INGOT);
                goldDoorPack.createPackRecipes(this, exporter);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_GOLD_BLOCK, Blocks.GOLD_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_GOLD_BLOCK, 2)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GOLD_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GOLD_BRICKS, Blocks.GOLD_BLOCK);
                ...
                diamondPack.createPackRecipes(this, exporter);
                ...
                diamondBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedDiamondPack.createPackRecipes(this, exporter);
                ...
                polishedDiamondPack.createPackRecipes(this, exporter);

                DoorPack diamondDoorPack = new DoorPack(ModBlocks.DIAMOND_TRAPDOOR, ModBlocks.DIAMOND_DOOR, Items.DIAMOND, Items.DIAMOND);
                diamondDoorPack.createPackRecipes(this, exporter);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_DIAMOND_BLOCK, Blocks.DIAMOND_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_DIAMOND_BLOCK, 2)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DIAMOND_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DIAMOND_BRICKS, Blocks.DIAMOND_BLOCK);
                ...
                ironPack.createPackRecipes(this, exporter);
                ...
                ironBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedIronPack.createPackRecipes(this, exporter);
                ...
                polishedIronPack.createPackRecipes(this, exporter);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_IRON_BLOCK, Blocks.IRON_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_IRON_BLOCK, 2)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.IRON_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.IRON_BRICKS, Blocks.IRON_BLOCK);
                ...
                emeraldPack.createPackRecipes(this, exporter);
                ...
                emeraldBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedEmeraldPack.createPackRecipes(this, exporter);
                ...
                polishedEmeraldPack.createPackRecipes(this, exporter);
                ...
                chiseledEmeraldPack.createPackRecipes(this, exporter);

                DoorPack emeraldDoorPack = new DoorPack(ModBlocks.EMERALD_TRAPDOOR, ModBlocks.EMERALD_DOOR, Items.EMERALD, Items.EMERALD);
                emeraldDoorPack.createPackRecipes(this, exporter);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_EMERALD_BLOCK, Blocks.EMERALD_BLOCK);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_EMERALD_BLOCK, Blocks.EMERALD_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_EMERALD_BLOCK, 2)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.EMERALD_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.EMERALD_BRICKS, Blocks.EMERALD_BLOCK);
                ...
                lapisPack.createPackRecipes(this, exporter);
                ...
                lapisBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedLapisPack.createPackRecipes(this, exporter);
                ...
                polishedLapisPack.createPackRecipes(this, exporter);

                DoorPack lapisDoorPack = new DoorPack(ModBlocks.LAPIS_TRAPDOOR, ModBlocks.LAPIS_DOOR, Items.LAPIS_LAZULI, Items.LAPIS_LAZULI);
                lapisDoorPack.createPackRecipes(this, exporter);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_LAPIS_BLOCK, Blocks.LAPIS_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_LAPIS_BLOCK, 2)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.LAPIS_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.LAPIS_BRICKS, Blocks.LAPIS_BLOCK);
                ...
                coalPack.createPackRecipes(this, exporter);
                ...
                coalBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedCoalPack.createPackRecipes(this, exporter);
                ...
                polishedCoalPack.createPackRecipes(this, exporter);

                DoorPack coalDoorPack = new DoorPack(ModBlocks.COAL_TRAPDOOR, ModBlocks.COAL_DOOR, Items.COAL, Items.COAL);
                coalDoorPack.createPackRecipes(this, exporter);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_COAL_BLOCK, Blocks.COAL_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_COAL_BLOCK, 2)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.COAL_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.COAL_BRICKS, Blocks.COAL_BLOCK);
                ...
                calcitePack.createPackRecipes(this, exporter);
                ...
                netheritePack.createPackRecipes(this, exporter);
                ...
                netheriteBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedNetheritePack.createPackRecipes(this, exporter);
                ...
                polishedNetheritePack.createPackRecipes(this, exporter);
                ...
                netheriteDoorPack.createPackRecipes(this, exporter);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_NETHERITE_BLOCK, Blocks.NETHERITE_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_NETHERITE_BLOCK, 2)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.NETHERITE_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.NETHERITE_BRICKS, Blocks.NETHERITE_BLOCK);
                ...
                amethystPack.createPackRecipes(this, exporter);
                ...
                amethystBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedAmethystPack.createPackRecipes(this, exporter);
                ...
                polishedAmethystPack.createPackRecipes(this, exporter);

                // ESTA ES DISTINTA PORQUE SE HACEN BLOQUES DE AMATISTA DE LA OTRA FORMA
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.AMETHYST_TRAPDOOR)
                        .pattern("RRR")
                        .pattern("RRR")
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.AMETHYST_DOOR, 3)
                        .pattern("RR")
                        .pattern("RR")
                        .pattern("RR")
                        .input('R',Items.AMETHYST_SHARD)
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_AMETHYST_BLOCK, Blocks.AMETHYST_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_AMETHYST_BLOCK, 2)
                        .input(Blocks.AMETHYST_BLOCK)
                        .input(Blocks.CALCITE)
                        .criterion(hasItem(Blocks.AMETHYST_BLOCK), conditionsFromItem(Blocks.AMETHYST_BLOCK))
                        .criterion(hasItem(Blocks.CALCITE), conditionsFromItem(Blocks.CALCITE))
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.AMETHYST_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.AMETHYST_BRICKS, Blocks.AMETHYST_BLOCK);
                ...
                redstonePack.createPackRecipes(this, exporter);
                ...
                redstoneBrickPack.createPackRecipes(this, exporter);
                ...
                calcifiedRedstonePack.createPackRecipes(this, exporter);
                ...
                polishedRedstonePack.createPackRecipes(this, exporter);

                DoorPack redstoneDoorPack = new DoorPack(ModBlocks.REDSTONE_TRAPDOOR, ModBlocks.REDSTONE_DOOR, Items.REDSTONE, Items.REDSTONE);
                redstoneDoorPack.createPackRecipes(this, exporter);

                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_REDSTONE_BLOCK, Blocks.REDSTONE_BLOCK);

                createShapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_REDSTONE_BLOCK, 2)
                ...
                createShaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.REDSTONE_BRICKS, 4)
                        .pattern("RR")
                        .pattern("RR")
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.REDSTONE_BRICKS, Blocks.REDSTONE_BLOCK);
                ...
                obsidianPack.createPackRecipes(this, exporter);
                ...
                bedrockPack.createPackRecipes(this, exporter);
                ...
                sculkPack.createPackRecipes(this, exporter);
                ...
                packedIcePack.createPackRecipes(this, exporter);
                ...
                blueIcePack.createPackRecipes(this, exporter);
                ...
                icePack.createPackRecipes(this, exporter);
                ...
                createShapeless(RecipeCategory.TRANSPORTATION, ModItems.MAGIC_MIRROR, 1)
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.STONE_LONGSWORD)
                        .pattern("  C")
                        .pattern(" C ")
                        .pattern("S  ")
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.GOLDEN_LONGSWORD)
                        .pattern("  G")
                        .pattern(" G ")
                        .pattern("S  ")
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.DIAMOND_LONGSWORD)
                        .pattern("  D")
                        .pattern(" D ")
                        .pattern("S  ")
                ...
                createShaped(RecipeCategory.DECORATIONS, ModBlocks.PROTECTOR_BLOCK)
                        .pattern("DED")
                        .pattern("DHD")
                        .pattern("ABA")
    ...
    private record BlockPack(
        ...
        public void createPackRecipes(RecipeGenerator generator, RecipeExporter exporter) {

            generator.createStairsRecipe(this.stairs, Ingredient.ofItems(this.baseBlock)).criterion(RecipeGenerator.hasItem(this.baseBlock), generator.conditionsFromItem(this.baseBlock)).offerTo(exporter);
            generator.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, this.stairs, this.baseBlock);
            generator.offerSlabRecipe(RecipeCategory.BUILDING_BLOCKS, this.slab, this.baseBlock);
            generator.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, this.slab, this.baseBlock, 2);
            generator.createFenceRecipe(this.fence, Ingredient.ofItems(this.baseBlock)).criterion(RecipeGenerator.hasItem(this.baseBlock), generator.conditionsFromItem(this.baseBlock)).offerTo(exporter);
            generator.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, this.fence, this.baseBlock, 2);
            generator.createFenceGateRecipe(this.fenceGate, Ingredient.ofItems(this.baseBlock)).criterion(RecipeGenerator.hasItem(this.baseBlock), generator.conditionsFromItem(this.baseBlock)).offerTo(exporter);
            generator.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, this.fenceGate, this.baseBlock, 2);
            generator.offerWallRecipe(RecipeCategory.BUILDING_BLOCKS, this.wall, this.baseBlock);
            generator.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, this.wall, this.baseBlock);
        }
    }
    ...
    private record DoorPack(
        ...
        public void createPackRecipes(RecipeGenerator generator, RecipeExporter exporter) {
            generator.createShaped(RecipeCategory.BUILDING_BLOCKS, this.trapdoor)
                    .pattern("RR")
                    .pattern("RR")
                    .input('R', this.trapDoorIngredient)
                    .criterion(RecipeGenerator.hasItem(this.trapDoorIngredient), generator.conditionsFromItem(this.trapDoorIngredient))
                    .offerTo(exporter);

            generator.createShaped(RecipeCategory.BUILDING_BLOCKS, this.door, 3)
                    .pattern("RR")
                    .pattern("RR")
                    .pattern("RR")
                    .input('R',this.doorIngredient)
                    .criterion(RecipeGenerator.hasItem(this.doorIngredient), generator.conditionsFromItem(this.doorIngredient))
                    .offerTo(exporter);
        }
    }
