...
//
//    public static final EntityModelLayer MANTIS = new EntityModelLayer(Identifier.of(MoreMineralBlocks.MOD_ID, "mantis"), "main");
//
...
//        ModelPartData mantis = modelPartData.addChild("mantis", ModelPartBuilder.create(), ModelTransform.of(-0.5F, -3.0F, -28.0F, 0.3927F, 0.0F, 0.0F));
//
