...
//            new OnDamageTakenEffect(MobEffectCategory.HARMFUL, 12779366)
//                    .addAttributeModifier(ModEntityAttributes.CUMULATIVE_DAMAGE_TAKEN, ResourceLocation.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "cumulative_damage_taken"), 0.5, AttributeModifier.Operation.ADD_VALUE));
