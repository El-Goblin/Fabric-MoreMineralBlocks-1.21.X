...
public class MoreMineralBlocksStructurePlacement {
    ...
    public static void registerStructurePlacementTypes() {
        DISTANCE_BASED_STRUCTURE_PLACEMENT = Registry.register(Registries.STRUCTURE_PLACEMENT, Identifier.of(MoreMineralBlocks.MOD_ID, "distance_based_structure_placement"), () -> DistanceBasedStructurePlacement.CODEC);
    }
}
