...
import net.elgoblin.moremineralblocks.client.models.DimensionalPocketClosedModel;
...
public class DimensionalPocketRenderer implements SpecialModelRenderer<DimensionalPocketRenderer.Data> {
    ...
    private static final Identifier[] TEXTURES_BY_COLOR = {
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_red.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_orange.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_yellow.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_lime.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_green.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_cyan.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_light_blue.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_blue.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_purple.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_magenta.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_pink.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_brown.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_white.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_light_gray.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_gray.png"),
            Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "textures/item/dimensional_pocket/open/dimensional_pocket_open_black.png"),
    };
