package net.elgoblin.moremineralblocks.client.models;
...
public class ModModelLayers {
    ...
    public static final ModelLayerLocation DIMENSIONAL_POCKET_OPEN =
            new ModelLayerLocation(
                    Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "dimensional_pocket_open"
                    ),
                    "main"
            );
    ...
    public static final ModelLayerLocation DIMENSIONAL_POCKET_CLOSED =
            new ModelLayerLocation(
                    Identifier.fromNamespaceAndPath(MoreMineralBlocks.MOD_ID, "dimensional_pocket_closed"
                    ),
                    "main"
            );
