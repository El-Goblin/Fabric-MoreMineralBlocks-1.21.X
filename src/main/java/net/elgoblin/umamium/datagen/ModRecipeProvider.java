    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider provider, RecipeOutput recipeOutput) {
        return new RecipeProvider(provider, recipeOutput) {
            ...
            public void buildRecipes() {
                ...
                generateSetRecipes(ModBlocks.GOLD_SET, Items.GOLD_INGOT, "gold");

                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GOLD_BRICKS, 1)
                        .pattern("##")
                        .pattern("##")
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_GOLD_BLOCK, 2)
                        ...
                        .group("gold")
                        .save(output);
                generateSetRecipes(ModBlocks.CALCIFIED_GOLD_SET, "gold");

                // DIAMOND

                generateSetRecipes(ModBlocks.DIAMOND_SET, Items.DIAMOND, "diamond");

                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DIAMOND_BRICKS, 1)
                        .pattern("##")
                        .pattern("##")
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_DIAMOND_BLOCK, 2)
                        ...
                        .group("diamond")
                        .save(output);
                generateSetRecipes(ModBlocks.CALCIFIED_DIAMOND_SET, "diamond");

                // IRON

                generateSetRecipes(ModBlocks.IRON_SET, "iron");

                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.IRON_BRICKS, 1)
                        .pattern("##")
                        .pattern("##")
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_IRON_BLOCK, 2)
                        ...
                        .group("iron")
                        .save(output);
                generateSetRecipes(ModBlocks.CALCIFIED_IRON_SET, "iron");

                // EMERALD

                generateSetRecipes(ModBlocks.EMERALD_SET, Items.EMERALD, "emerald");

                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.EMERALD_BRICKS, 1)
                        .pattern("##")
                        .pattern("##")
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_EMERALD_BLOCK, 2)
                        ...
                        .group("emerald")
                        .save(output);
                generateSetRecipes(ModBlocks.CALCIFIED_EMERALD_SET, "emerald");

                // AMETHYST

                generateSetRecipes(ModBlocks.AMETHYST_SET, "amethyst");
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_AMETHYST_BLOCK, 2)
                        ...
                        .group("amethyst")
                        .save(output);
                generateSetRecipes(ModBlocks.CALCIFIED_AMETHYST_SET, "amethyst");
                ...
                generateSetRecipes(ModBlocks.LAPIS_SET, Items.LAPIS_LAZULI, "lapis");

                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.LAPIS_BRICKS, 1)
                        .pattern("##")
                        .pattern("##")
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_LAPIS_BLOCK, 2)
                        ...
                        .group("lapis")
                        .save(output);
                generateSetRecipes(ModBlocks.CALCIFIED_LAPIS_SET, "lapis");

                // COAL

                generateSetRecipes(ModBlocks.COAL_SET, Items.COAL, "coal");

                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.COAL_BRICKS, 1)
                        .pattern("##")
                        .pattern("##")
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_COAL_BLOCK, 2)
                        ...
                        .group("coal")
                        .save(output);
                generateSetRecipes(ModBlocks.CALCIFIED_COAL_SET, "coal");
                ...
                generateSetRecipes(ModBlocks.REDSTONE_SET, Items.REDSTONE, "redstone");

                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.REDSTONE_BRICKS, 1)
                        .pattern("##")
                        .pattern("##")
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCIFIED_REDSTONE_BLOCK, 2)
                        ...
                        .group("redstone")
                        .save(output);
                generateSetRecipes(ModBlocks.CALCIFIED_REDSTONE_SET, "redstone");

                // OBSIDIAN

                generateSetRecipes(ModBlocks.OBSIDIAN_SET, "obsidian");

                // SCULK

                generateSetRecipes(ModBlocks.SCULK_SET, "sculk");

                // BEDROCK

                generateSetRecipes(ModBlocks.BEDROCK_SET, "bedrock");

                // CALCITE

                generateSetRecipes(ModBlocks.CALCITE_SET, "calcite");
                ...
                generateSetRecipes(ModBlocks.FLINT_SET, Items.FLINT, "flint");

                // ICE

                generateSetRecipes(ModBlocks.ICE_SET, "ice");

                // PACKED_ICE

                generateSetRecipes(ModBlocks.PACKED_ICE_SET, "packed_ice");

                // BLUE_ICE

                generateSetRecipes(ModBlocks.BLUE_ICE_SET, "blue_ice");
            }

            private void generateSetRecipes(ModBlocks.BlockSet blockSet, Item ingredient, String group) {
            ...
            private void generateSetRecipes(ModBlocks.BlockSet blockSet, String group) {
                Ingredient baseIngredient = Ingredient.of(blockSet.base());
