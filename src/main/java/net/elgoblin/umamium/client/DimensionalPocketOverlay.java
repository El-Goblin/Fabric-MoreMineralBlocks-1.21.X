...
public class DimensionalPocketOverlay {
    ...
    public static final Identifier COLOREABLE_GROUP_TEXTURE = Identifier.fromNamespaceAndPath(
            Umamium.MOD_ID, "textures/item/dimensional_pocket/overlay/dimensional_pocket_coloreable_group_texture.png");

    public static void register() {
        HudElementRegistry.attachElementBefore(
                VanillaHudElements.CHAT,
                Identifier.fromNamespaceAndPath(Umamium.MOD_ID, "infinite_item_overlay"),
